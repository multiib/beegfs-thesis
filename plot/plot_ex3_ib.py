...
def main() -> None:
    ...
    # Plot data
    plot_line(ax, msg_size, direct_mean, color=palette["ib"], label="SuperSockets (direct)", marker="o")
    plot_line(ax, msg_size, buffered_mean, color=palette["ib2"], label="SuperSockets (buffered)", marker="s")
