...
def main() -> None:
    ...
    plot_line(ax, msg_size, dis_mean, color=palette["dis2"], label="IPoPCIe", marker="s")
    plot_line(ax, msg_size, ssocks_mean, color=palette["dis"], label="SuperSockets", marker="o")
    ...
    plot_std_fill(ax, msg_size, dis_mean, dis_std, palette["dis2"])
    plot_std_fill(ax, msg_size, ssocks_mean, ssocks_std, palette["dis"])
