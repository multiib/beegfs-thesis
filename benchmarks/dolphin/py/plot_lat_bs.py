#!/usr/bin/env python3
"""
Plot latency vs. message size (mean of all JSON runs) for two datasets
...
IMG_DIR = os.path.expandvars("$HOME/beegfs-thesis/benchmarks/dolphin/img/scipp")
DATA_DIR1 = os.path.expandvars("$HOME/beegfs-thesis/benchmarks/dolphin/out/scipp/mpg")
DATA_DIR2 = os.path.expandvars("$HOME/beegfs-thesis/benchmarks/dolphin/out/scipp/ex3")
